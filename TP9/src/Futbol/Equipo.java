...
public class Equipo {
    ...
    public String agregarDelantero(String nombre, double velocidad, double potencia) {
    ...
    public String agregarDefensor(String nombre, double velocidad, double potencia) {
    ...
    public String agregarArquero(String nombre, double velocidad, double potencia, double efectividad) {
