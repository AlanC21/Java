...
public class Mago extends Personaje{
	...
	public void recuperarMagia() {
		...
		System.out.println("Medistaste, recuperaste " + numeroMagia + " de magia. Ahora tenes " + this.cantidadMagia + " de magia.");
	}
	public void teletransportarse(Posicion p) {
		if(cantidadMagia >= 2000) {
			...
			System.out.println("No tienes suficiente magia para poder teletransportarse");
		}
	}
